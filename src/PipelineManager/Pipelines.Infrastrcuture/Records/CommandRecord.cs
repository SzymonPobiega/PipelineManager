...
namespace Pipelines.Infrastructure.Records
{
    public class CommandRecord
    {
        ...
        public virtual DateTime ExecuteAfterDate { get; protected set; }

        public virtual string PayloadJson { get; set; }
        public virtual string PayloadTypeName { get; set; }

        public CommandRecord(object payload, DateTime enqueueDate, DateTime executeAfterDate)
        {
