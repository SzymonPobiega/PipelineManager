...
{
    public class ReleaseCandidateDeploymentFailedEvent
    {
        [NotNull]
        ...
        public ReleaseCandidateDeploymentFailedEvent([NotNull] string uniqueDeploymentId, int buildId, [NotNull] string projectName, [NotNull] string versionNumber, [NotNull] string environment)
        {
